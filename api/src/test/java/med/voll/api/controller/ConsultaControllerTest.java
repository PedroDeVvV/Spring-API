...
import med.voll.api.domain.consulta.services.ConsultaService;
...
class ConsultaControllerTest {
    ...
    @Test
    @DisplayName("Deveria devolver o json ")
    @WithMockUser
        //dispensa a autenticação
    void agendar_cenario2() throws Exception {
        var data = LocalDateTime.now().plusHours(1);
        var especialidadde = Especialidade.CARDIOLOGIA;
        ...
        var response = mvc
                .perform(post("/consultas")
                        ...
                        .content(dadosAgendamentoConsultaJson.write(
                                new DadosAgendamentoConsulta(2l, 5l, data, especialidadde)
                        ).getJson())
                )
